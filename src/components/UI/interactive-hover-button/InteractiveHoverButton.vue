<template>
  <button
    ...
    :class="
      cn(
        'group relative w-auto cursor-pointer overflow-hidden rounded-full border bg-background p-2 px-6 text-center font-semibold text-white bg-green-600',
        props.class
      )
    "
  >
  ...
  class="lucide lucide-arrow-right text-green-600"
>
  <path d="M5 12h14" />
