    ...
    >
      ...
      >
        <Motion
          ...
          class="absolute top-0 w-[2px] bg-[#511378]"
        ></Motion>
      </div>
      ...
      >
        ...
        >
          <div class=" hidden md:flex size-12 items-center justify-center rounded-full bg-[#634078] text-white font-bold">
            {{ index + 1 }}
          </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-center gap-8 relative">
          ...
          >
            ...
            />
             <div class=" absolute translate-x-1/2 -bottom-5  right-1/2 md:hidden flex size-12 items-center justify-center rounded-full bg-[#511378] text-white font-bold">
            {{ index + 1 }}
          </div>
          </div>
          ...
          >
            ...
            <a 
              href="#" 
              class="text-[#511378] font-medium inline-flex items-center"
              data-aos="fade-up"
