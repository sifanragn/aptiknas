  ...
  <section ref="timelineContainerRef" class="w-full font-sans py-16 relative">
    ...
    >
      ...
      <p class="text-gray-600 max-w-2xl mx-auto mb-12">
        Ikuti 4 langkah praktis berikut untuk menjadi anggota resmi MGBK dan
        nikmati berbagai manfaat keanggotaan.
      </p>
    </div>
      ...
      >
        ...
        <div class="flex flex-col md:flex-row items-center gap-8 relative">
          ...
          >
            ...
            <a
              href="#"
              class="text-green-600 font-medium inline-flex items-center"
              data-aos="fade-up"
...
const hows = ref([
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&w=500&q=80",
  },
  {
    id: 2,
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1573496775067-507b28dc04a2?auto=format&fit=crop&w=500&q=80",
  },
  {
    id: 3,
    label: "Pembayaran",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1604594878355-35a4a1628741?auto=format&fit=crop&w=500&q=80",
  },
  {
    id: 4,
    label: "Aktivasi Keanggotaan",
    description:
      "Setelah pembayaran dikonfirmasi, keanggotaan Anda akan diaktivasi dan Anda dapat menikmati semua benefit.",
    imageUrl:
